...
apt-get install -y casacore-tools python-lofar git build-essential cmake cython python-casacore gfortran libboost-python1.58-dev python-pip python-astropy python-pyregion python-emcee python-ephem python-deap libfftw3-dev python-psutil python-pyfits python-virtualenv wget
apt-get autoremove
apt-get clean
